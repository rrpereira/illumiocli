...
func TestGetContainerClusters_Success(t *testing.T) {
	mockResponse := `[
		{
	...
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if r.URL.Path != "/api/v1/orgs/1/container_clusters" {
			t.Errorf("Expected path /api/v1/orgs/1/container_clusters, got %s", r.URL.Path)
		}
	...
	clusters, err := pce.GetContainerClusters()
...
func TestGetContainerClusters_Failure_403(t *testing.T) {
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		if r.Method != "GET" {
			t.Errorf("Expected GET method, got %s", r.Method)
		}
...
func TestGetContainerClusters_Failure_404(t *testing.T) {
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		if r.Method != "GET" {
			t.Errorf("Expected GET method, got %s", r.Method)
		}
	...
	if err == nil {
		t.Error("Expected an error due to 404 status, but got nil")
	}
	if clusters != nil {
		t.Errorf("Expected clusters to be nil, got %v", clusters)
	}
